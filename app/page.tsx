...
const TRANSLATIONS = {
  da: {
    ...
    level1Features: ["Next.js + Tailwind CSS", "Mobilvenlig & tilgængelig", "SEO (GPT) optimeret fra dag ét", "Hostet gratis på Vercel"],
  ...
  en: {
    ...
    level1Features: ["Next.js + Tailwind CSS", "Mobile-friendly & accessible", "SEO (GPT) optimized from day one", "Hosted free on Vercel"],
